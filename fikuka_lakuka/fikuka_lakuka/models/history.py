...
from fikuka_lakuka.fikuka_lakuka.models import Observation, ActionSpace


class History:
    def __init__(self, past_observations: List[Observation] = None, past_actions: List[ActionSpace] = None):
